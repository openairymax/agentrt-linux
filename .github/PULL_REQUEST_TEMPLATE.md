...
- [ ] [SC] shared contract layer change (requires dual CI per OS-IRON-008)
...
<!-- List any OS-*-NNN rule IDs referenced in this PR, e.g., OS-IRON-009, OS-STD-FMT-001 -->
...
<!-- CI status, KUnit/kselftest results, etc. -->
